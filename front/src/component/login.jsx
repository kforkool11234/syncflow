...
function Login() {
    ...
    return (
        <div className="content flex items-center justify-center mr-20 min-h-screen ">
            <form className="bg-gray-800 p-8 rounded-lg shadow-md max-w-sm w-full" onSubmit={handleLogin}>
