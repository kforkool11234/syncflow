    ...
    return (
        <div className="content flex flex-col p-8">
            <div className="max-w-6xl mx-auto w-full">
                <div className="bg-white/95 dark:bg-gray-900/90 backdrop-blur-3xl rounded-3xl shadow-xl border border-white/20 dark:border-gray-700/30 p-8 transition-colors duration-300">
                    {/* Header Section */}
                    <div className="border-b border-gray-100 dark:border-gray-700/50 pb-8 mb-8">
                        <div className="flex flex-col md:flex-row justify-between items-start gap-6">
                            <div>
                                ...
                                <div className="flex items-center gap-3 text-gray-600 dark:text-gray-400">
                                    <span className="font-semibold bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 px-3 py-1 rounded-full text-sm">Team Lead</span>
                            ...
                            <div className="flex flex-col gap-3 min-w-[200px]">
                                <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
                                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Project Deadline</p>
                                ...
                                <a
                                    ...
                                    className="flex items-center justify-center gap-2 w-full p-3 bg-gray-900 dark:bg-gray-700 text-white rounded-xl hover:bg-gray-800 dark:hover:bg-gray-600 transition-all font-medium"
                                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <section>
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <button
                                        ...
                                        className="bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 px-4 py-2 rounded-xl font-medium transition-all"
                                    >
                                        + Add Task
                                    </button>
                                </div>
                                    ...
                                    {arr.timeline && arr.timeline.length > 0 ? (
                                        arr.timeline.map((item) => (
                                            <div key={item._id} className={`p-5 rounded-2xl border transition-all ${item.done
                                                ...
                                                : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm hover:border-indigo-200 dark:hover:border-indigo-500/50'
                                                }`}>
                                                <div className="flex items-start gap-4">
                                                    ...
                                                    <div className="flex-grow">
                                                        <div className="flex justify-between items-start mb-2">
                                                            <h3 className={`font-bold text-lg ${item.done ? 'text-gray-500 dark:text-gray-500 line-through' : 'text-gray-900 dark:text-white'}`}>
                                                                {item.name}
                                                            </h3>
                                                        ...
                                                        <p className={`text-gray-600 dark:text-gray-400 ${item.done && 'line-through'}`}>{item.description}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ))
                                        ...
                                        <div className="text-center py-12 bg-gray-50 dark:bg-gray-800/30 rounded-2xl border border-dashed border-gray-300 dark:border-gray-700">
                                            <p className="text-gray-500 dark:text-gray-400">No timeline items yet.</p>
                                        </div>
                                    )}
                                </div>
                                ...
                                {/* Add Task Form */}
                                {showAddTask && (
                                    <div className="mt-6 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-200 dark:border-gray-700 animate-in fade-in slide-in-from-top-4">
                                        <h3 className="font-bold text-gray-900 dark:text-white mb-4">New Timeline Task</h3>
                                        <div className="space-y-4">
                                            <input
                                                placeholder="Task Name"
                                                className="w-full p-3 rounded-xl border border-gray-200 dark:border-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white transition-all"
                                                value={task.name}
                                            ...
                                            <button
                                                ...
                                                className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl shadow-lg shadow-indigo-200 dark:shadow-none transition-all"
                                            >
                                                Add Task
                                            </button>
                                        </div>
                            ...
                            <section>
                                <div className="flex justify-between items-center mb-6">
                                    ...
                                    <button
                                        ...
                                        className="bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 hover:bg-purple-100 dark:hover:bg-purple-900/50 px-4 py-2 rounded-xl font-medium transition-all"
                                    >
                                        + Add Link
                                    </button>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {arr.links && arr.links.map((linkItem, index) => (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="block p-4 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl hover:shadow-md hover:border-purple-200 dark:hover:border-purple-500/50 transition-all group"
                                        >
                                            <h4 className="font-bold text-gray-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">{linkItem.name}</h4>
                                            <span className="text-sm text-gray-500 dark:text-gray-400 truncate block mt-1">{linkItem.url}</span>
                                        </a>
                                    ))}
                                    {(!arr.links || arr.links.length === 0) && (
                                        <p className="text-gray-500 dark:text-gray-400 text-sm col-span-full italic">No additional resources added.</p>
                                    )}
                                </div>
                                    ...
                                    <div className="mt-6 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-200 dark:border-gray-700 animate-in fade-in slide-in-from-top-4">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                                            <input
                                                ...
                                                className="w-full p-3 rounded-xl border border-gray-200 dark:border-gray-600 focus:ring-2 focus:ring-purple-500 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                                value={link.name}
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-xl shadow-lg shadow-purple-200 dark:shadow-none transition-all"
                                        >
                                            Save Resource
                                        </button>
                                    </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-3xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm sticky top-8">
                                <div className="flex justify-between items-center mb-6">
                                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Team</h2>
                                    <button
                                        onClick={() => setShowAddTeam(!showAddteam)}
                                        className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-all"
                                    >
                                ...
                                <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                                    {arr.teamMembers && arr.teamMembers.length > 0 ? (
                                        arr.teamMembers.map((member, index) => (
                                            <div key={member._id || index} className="p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="font-bold text-gray-900 dark:text-white">{member.id}</p>
                                ...
                                {showAddteam && (
                                    <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 animate-in fade-in">
                                        <div className="space-y-3">
                                            <input
                                                placeholder="Member Name"
                                                className="w-full p-2.5 rounded-lg border border-gray-200 dark:border-gray-600 text-sm focus:ring-2 focus:ring-blue-500 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                                value={team.name}
