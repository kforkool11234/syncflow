    ...
    return (
        <div className="content flex-col p-8">
            <div className="max-w-6xl mx-auto w-full">
                <div className="bg-white/95 dark:bg-gray-900/90 backdrop-blur-3xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/30 p-8 transition-colors duration-300">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
                        <div>
                            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Assigned Tasks</h2>
                            <p className="text-gray-600 dark:text-gray-400">Track and manage your project deliverables</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                            <div className="relative group">
                                <select
                                    ...
                                    className="appearance-none w-full sm:w-48 px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-xl text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all cursor-pointer hover:bg-white dark:hover:bg-gray-700"
                                >
                            ...
                            filteredTasks.map(task => (
                                <div
                                    ...
                                    className={`group p-6 rounded-2xl border transition-all duration-300 hover:shadow-lg hover:scale-[1.01] ${task.done
                                        ...
                                        : 'bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700 hover:border-indigo-200 dark:hover:border-indigo-800/50 shadow-sm'
                                        }`}
                                >
                                    <div className="flex flex-col sm:flex-row justify-between gap-4">
                                        <div className="flex-1 space-y-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <h3 className="text-lg font-bold text-gray-900 dark:text-white line-clamp-1">{task.chat.chatName}</h3>
                                            </div>
                                            ...
                                            <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 dark:text-gray-400 pt-2">
                                                <div className="flex items-center gap-2">
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                                    <span className="font-medium text-gray-700 dark:text-gray-300">Assigned by:</span> {task.to.displayName}
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                                    <span className={`font-medium ${new Date(task.due_date) < new Date() && !task.done ? 'text-red-600 dark:text-red-400' : 'text-gray-700 dark:text-gray-300'}`}>
                                        ...
                                        <div className="flex items-center">
                                            {!task.done && (
                                                <button
                                                    ...
                                                    className="w-full sm:w-auto px-6 py-3 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-700 dark:hover:bg-indigo-600 text-white font-semibold rounded-xl transition-all duration-200 shadow-md hover:shadow-indigo-200 dark:hover:shadow-none flex items-center justify-center gap-2 active:scale-95"
                                                >
